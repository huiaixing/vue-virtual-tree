...
import { formItemContextKey } from 'element-plus/es/components/form/index.mjs';
import { selectKey } from 'element-plus/es/components/select/src/token.mjs';
...
export default defineComponent({
  ...
  components: { ElTreeNode, VirtualTreeNode, RecycleScroller },
  props: {
    data: {
      type: Array,
      default: () => [],
  ...
  setup(props, ctx) {
    ...
    const myNodeList = ref([...root.value.childNodes]);
